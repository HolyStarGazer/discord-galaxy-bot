    ...
    async execute(interaction) {
        ...
        if (scope === 'all') {
            ...
            if (count > 0) {
                ...
                await interaction.reply({
                    content: 'You don\'t have any conversations to clear.',
                    flags: MessageFlags.Ephemeral
                });
            }
        } else {
            ...
            if (history.length === 0) {
                return interaction.reply({
                    content: 'You don\'t have any conversation history in this channel to clear.',
                    flags: MessageFlags.Ephemeral
                });
            }
            ...
            await interaction.reply({
                content: `Cleared your conversation history in this channel. (${history.length} message(s))`,
                flags: MessageFlags.Ephemeral
            });
        }
    }
